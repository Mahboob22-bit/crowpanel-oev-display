...
2.  **Access Point Mode (AP):** Startet einen AP ("CrowPanel-Setup"), wenn keine Konfiguration vorhanden ist oder die Verbindung fehlschlägt.
...
*   `EVENT_WIFI_AP_MODE`: Access Point gestartet.
